...
export async function login({
  email,
  password,
}: loginSchemaType): Promise<loginSchemaType> {
...
export async function register(
  registerData: registerSchemaType
): Promise<registerSchemaType> {
...
export async function updateUserProfile(
  updateUserProfileData: updateUserProfileSchemaType
): Promise<updateUserProfileSchemaType> {
