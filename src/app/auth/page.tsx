...
export default function AuthForm() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="grow flex items-center justify-center bg-gray-100 px-4 py-12">
            ...
            <form action={currentAction} className="space-y-4">
              ...
              <div className="relative">
                <input
                  type="email"
                  name="email"
                  placeholder={isLogin ? "ایمیل" : "ایمیل"}
                  className="w-full px-4 py-3 border rounded-lg pl-10 focus:ring-2 focus:ring-orange-400 focus:outline-none"
                  required
                  disabled={isPending}
                />
