...
const CourseCard: React.FC<CourseCardProps> = ({ id, title, description }) => {
  return (
    <Link href={`/courses/${id}`}>
      <article className="group w-[362px] rounded-[10px] overflow-hidden flex flex-col border cursor-pointer hover:border-[#FF8E50] hover:shadow-xl duration-700">
        ...
        <div className="h-[8px] w-full flex justify-center items-center relative bottom-3">
          <div className="size-[48px] rounded-full overflow-hidden flex justify-center items-center box-content border-[6px] border-white">
            <div className="bg-red-500 size-[48px]" />
          </div>
        </div>
        <div className="h-[30px] self-center p-1 mt-1 text-sm text-gray-600">
          شهرام پورحسین
        </div>
        ...
        <footer className="relative h-[56px] w-full border-t flex justify-center items-center duration-300">
          <div
